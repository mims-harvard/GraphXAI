...
def test_model_on_ShapeGGen(model, epochs_per_run=200, num_cvs=10):
...
if __name__ == '__main__':
    ...
    test_model_on_ShapeGGen(model, epochs_per_run=200)
    print('Graph: n=100, p=0.09, sn=13')

    test_model_on_ShapeGGen(model, epochs_per_run=100, num_cvs = 5)
