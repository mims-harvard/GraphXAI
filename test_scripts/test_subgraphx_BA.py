...
visualize_subgraph_explanation(L_hop[1], node_idx = node_idx, ax = axs[0], show = False, connected = True)

axs[1].set_title('SubgraphX Chosen Subgraph')
visualize_subgraph_explanation(L_hop[1], node_idx = node_idx, node_weights = subgraph_node_mask.type(torch.int32),
...
#visualize_subgraph_explanation(subgraph_edge_index, node_idx = None, ax = axs[1], show = False, connected = False)
