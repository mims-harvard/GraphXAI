...
bah = torch.load(open(os.path.join(my_base_graphxai, 'data/ShapeGGen/unzipped/SG_triangles.pickle'), 'rb'))
...
if args.model.lower() == 'gin':
    ...
    save_exp_dir = os.path.join(my_base_graphxai, 'formal/ShapeGGen', 'bigSG_explanations', 'L1_triangle', args.exp_method.upper())
elif args.model.lower() == 'gin2':
    save_exp_dir = os.path.join(my_base_graphxai, 'formal/ShapeGGen', 'bigSG_explanations', 'L2_triangle', args.exp_method.upper())
